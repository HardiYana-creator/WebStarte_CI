        ...
        <div class="form-group-inner">
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <input type="text" name="password_confirm" class='form-control'  placeholder="Confirm new Password">
                </div>
            </div>
        </div>
        <div class="form-group-inner">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <div class="login-horizental cancel-wp pull-left">
                            ...
                            <a href="<?= base_url() ?>Auth"><button class="btn btn-sm btn-primary login-submit-cs" type="btn">Back</button></a>
                        </div>
                    </div>
                </div>
            </div>
