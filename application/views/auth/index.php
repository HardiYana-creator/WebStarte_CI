      ...
      <div class="page-content-wrapper">
        ...
        <div class="card">
            <div class="card-body">
              ...
              <a href="<?=base_url()?>Auth/create_user"><button class="btn btn-primary radius-30 btn-sm">Add Users</button></a>
              <hr/>
            ...
            foreach ($users as $user):?>
                <tr>
                    ...
                    <td>
                        ...
                        ?>
                         <?php  
                           echo anchor(site_url("auth/delete_user/".$user->id),'<span class="adminpro-icon adminpro-warning-danger"></span> Delete',array('title'=>'Delete','class'=>'btn btn-custon-four btn-danger','id'=>'delete'));
                           ?> 
                    </td>
                </tr>
            <?php endforeach;?>
